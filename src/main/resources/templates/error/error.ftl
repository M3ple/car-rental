...
<title>乐有家error</title>
<meta name="viewport" content="width=device-width, initial-scale=1">

<link rel="stylesheet" href="${rootPath}/static/css/error//bootstrap.min.css">

<link rel="stylesheet" href="${rootPath}/static/css/error/style.css">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <#--<p style="color: red">-->
        <#--</p>-->
        <a href="https://i.leyoujia.com/jjslogin/index"><button class="btn green">返回首页</button></a>
      </div>
    </div>
  </div>
</main>

<script src="${rootPath}/static/js/error/gsap.min.js"></script>
<script src="${rootPath}/static/js/error/script.js"></script>
